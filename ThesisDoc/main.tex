...
\begin{figure}[htbp]
  ...
  \includegraphics[width=\linewidth, height=0.38\textheight, keepaspectratio]%
    {figures/fig1_regime_probabilities}
...
\midrule
\multicolumn{9}{l}{\footnotesize\textit{Return figures in \% per month; Corr.\ = conditional Pearson correlation between S\&P 500 TR and LT Bond.}} \\[2pt]
\midrule
...
\begin{minipage}{\linewidth}
\vspace{4pt}\footnotesize
\textit{Notes:} Excess log returns $= \log(1+r_t) - \log(1+r_{f,t})$ where $r_{f,t}$ is the one-month T-bill rate.
Regime assignments use the Viterbi hard-state sequence, best-seed HMM (Model A, seed\,=\,24, without gold).
...
The positive correlation in Regime~0 (+0.28) reflects the 2022 rate shock, in which equities and bonds fell simultaneously, breaking the traditional flight-to-quality relationship.
...
$^{*}$ Conservative 20\% sleeve: the only group where all investor types beat the benchmark on downside deviation simultaneously.
...
\begin{figure}[htbp]
  ...
  \includegraphics[width=\linewidth, height=0.42\textheight, keepaspectratio]%
    {figures/fig2_cumulative_wealth}
...
\begin{figure}[htbp]
  ...
  \includegraphics[width=\linewidth, height=0.48\textheight, keepaspectratio]%
    {figures/fig3_satellite_weights_grid}
...
\toprule
\textbf{Sleeve} & \textbf{Investor} & \textbf{CAGR} & \textbf{Sharpe} & \textbf{Max DD} & \textbf{Dwnside Dev} & \textbf{Sortino} & \textbf{Calmar} & \textbf{Turnover} & \textbf{NONE\%} \\
\midrule
\endfirsthead
\multicolumn{10}{l}{\small\textit{(continued)}} \\
\toprule
\textbf{Sleeve} & \textbf{Investor} & \textbf{CAGR} & \textbf{Sharpe} & \textbf{Max DD} & \textbf{Dwnside Dev} & \textbf{Sortino} & \textbf{Calmar} & \textbf{Turnover} & \textbf{NONE\%} \\
\midrule
\endhead
\midrule
\multicolumn{10}{r}{\small\textit{(continues on next page)}} \\
\endfoot
\bottomrule
\endlastfoot
% ── Floor = 0.001 ─────────────────────────────────────────────────────────
\multicolumn{10}{l}{\textbf{Score improvement floor = 0.001}} \\[2pt]
20\% & MV          & 8.06\% & 0.923 & $-$26.78\% & 7.05\% & 1.159 & 0.301 & 12.5\% & 32.6\% \\
20\% & MVS\_cons   & 8.09\% & 0.927 & $-$27.00\% & 6.94\% & 1.181 & 0.300 & 13.1\% & 30.7\% \\
20\% & MVS\,$\star$& 8.10\% & 0.927 & $-$27.00\% & 6.95\% & 1.181 & 0.300 & 12.7\% & 30.7\% \\
20\% & MVK         & 8.04\% & 0.923 & $-$27.38\% & 6.93\% & 1.176 & 0.294 & 12.4\% & 29.2\% \\[3pt]
30\% & MV          & 8.33\% & 0.935 & $-$25.39\% & 7.30\% & 1.156 & 0.328 & 19.5\% &  8.3\% \\
30\% & MVS\_cons   & 8.32\% & 0.936 & $-$25.51\% & 7.23\% & 1.166 & 0.326 & 19.9\% &  8.0\% \\
30\% & MVS\,$\star$& 8.39\% & 0.943 & $-$25.62\% & 7.24\% & 1.173 & 0.327 & 19.4\% &  8.3\% \\
30\% & MVK         & 8.24\% & 0.923 & $-$26.31\% & 7.26\% & 1.150 & 0.313 & 18.8\% &  7.2\% \\[3pt]
35\% & MV          & 8.55\% & 0.944 & $-$25.82\% & 7.42\% & 1.167 & 0.331 & 23.3\% &  4.5\% \\
35\% & MVS\_cons   & 8.49\% & 0.941 & $-$25.82\% & 7.40\% & 1.162 & 0.329 & 22.9\% &  5.7\% \\
35\% & MVS\,$\star$& 8.58\% & 0.949 & $-$25.82\% & 7.36\% & 1.179 & 0.332 & 22.3\% &  5.7\% \\
35\% & MVK         & 8.39\% & 0.930 & $-$25.91\% & 7.41\% & 1.148 & 0.324 & 22.1\% &  6.8\% \\[3pt]
40\% & MV          & 8.57\% & 0.931 & $-$26.54\% & 7.58\% & 1.147 & 0.323 & 26.9\% &  3.0\% \\
40\% & MVS\_cons   & 8.67\% & 0.945 & $-$26.54\% & 7.59\% & 1.158 & 0.327 & 26.3\% &  4.2\% \\
40\% & MVS\,$\star$& 8.74\% & 0.952 & $-$26.54\% & 7.58\% & 1.167 & 0.330 & 25.6\% &  4.5\% \\
40\% & MVK         & 8.65\% & 0.944 & $-$26.75\% & 7.58\% & 1.154 & 0.323 & 26.3\% &  4.9\% \\[3pt]
\textbf{45\%} & \textbf{MV}       & \textbf{8.60\%} & \textbf{0.920} & $\mathbf{-}$\textbf{27.25\%} & \textbf{7.78\%} & \textbf{1.123} & \textbf{0.316} & \textbf{29.9\%} & \textbf{1.5\%} \\
\textbf{45\%} & \textbf{MVS\_cons}& \textbf{8.78\%} & \textbf{0.939} & $\mathbf{-}$\textbf{27.25\%} & \textbf{7.77\%} & \textbf{1.145} & \textbf{0.322} & \textbf{29.9\%} & \textbf{3.0\%} \\
\textbf{45\%} & \textbf{MVS}\,$\star\dagger$ & \textbf{8.90\%} & \textbf{0.956} & $\mathbf{-}$\textbf{27.25\%} & \textbf{7.72\%} & \textbf{1.167} & \textbf{0.327} & \textbf{29.3\%} & \textbf{3.4\%} \\
\textbf{45\%} & \textbf{MVK}      & \textbf{8.76\%} & \textbf{0.941} & $\mathbf{-}$\textbf{27.64\%} & \textbf{7.76\%} & \textbf{1.145} & \textbf{0.317} & \textbf{29.6\%} & \textbf{3.0\%} \\[3pt]
50\% & MV          & 8.73\% & 0.923 & $-$27.95\% & 7.91\% & 1.120 & 0.312 & 32.7\% &  0.8\% \\
50\% & MVS\_cons   & 8.79\% & 0.932 & $-$28.15\% & 7.93\% & 1.125 & 0.312 & 32.8\% &  1.9\% \\
50\% & MVS\,$\star$& 8.93\% & 0.945 & $-$28.34\% & 7.91\% & 1.145 & 0.315 & 32.8\% &  1.5\% \\
50\% & MVK         & 8.71\% & 0.920 & $-$28.36\% & 7.96\% & 1.112 & 0.307 & 32.9\% &  1.5\% \\[6pt]
% ── Floor = 0.002 ─────────────────────────────────────────────────────────
\multicolumn{10}{l}{\textbf{Score improvement floor = 0.002}} \\[2pt]
20\% & MV\,$\star$ & 7.85\% & 0.909 & $-$27.33\% & 6.86\% & 1.162 & 0.287 &  6.2\% & 72.7\% \\
20\% & MVS\_cons   & 7.76\% & 0.898 & $-$27.55\% & 6.83\% & 1.155 & 0.282 &  6.3\% & 73.1\% \\
20\% & MVS         & 7.75\% & 0.897 & $-$27.55\% & 6.86\% & 1.148 & 0.281 &  6.0\% & 73.5\% \\
20\% & MVK         & 7.80\% & 0.901 & $-$27.92\% & 6.88\% & 1.152 & 0.280 &  7.3\% & 70.5\% \\[3pt]
30\% & MV          & 8.02\% & 0.921 & $-$25.39\% & 7.10\% & 1.145 & 0.316 & 14.8\% & 58.7\% \\
30\% & MVS\_cons\,$\star$ & 8.16\% & 0.934 & $-$25.51\% & 7.06\% & 1.170 & 0.320 & 14.6\% & 58.3\% \\
30\% & MVS         & 8.10\% & 0.929 & $-$25.62\% & 7.07\% & 1.161 & 0.316 & 14.6\% & 58.3\% \\
30\% & MVK         & 8.18\% & 0.933 & $-$26.31\% & 7.06\% & 1.173 & 0.311 & 13.5\% & 53.8\% \\[3pt]
35\% & MV          & 8.22\% & 0.933 & $-$25.28\% & 7.22\% & 1.153 & 0.325 & 16.9\% & 48.5\% \\
35\% & MVS\_cons\,$\star$ & 8.40\% & 0.950 & $-$25.28\% & 7.20\% & 1.180 & 0.332 & 15.7\% & 47.7\% \\
35\% & MVS         & 8.38\% & 0.946 & $-$25.55\% & 7.20\% & 1.178 & 0.328 & 16.0\% & 47.3\% \\
35\% & MVK         & 8.43\% & 0.946 & $-$25.90\% & 7.28\% & 1.171 & 0.325 & 17.7\% & 44.3\% \\[3pt]
40\% & MV          & 8.20\% & 0.916 & $-$25.99\% & 7.52\% & 1.107 & 0.315 & 21.1\% & 40.2\% \\
40\% & MVS\_cons   & 8.43\% & 0.938 & $-$26.46\% & 7.50\% & 1.139 & 0.319 & 22.1\% & 37.9\% \\
40\% & MVS         & 8.45\% & 0.939 & $-$26.46\% & 7.49\% & 1.142 & 0.319 & 22.4\% & 37.5\% \\
40\% & MVK\,$\star$& 8.54\% & 0.953 & $-$26.75\% & 7.39\% & 1.168 & 0.319 & 22.5\% & 35.2\% \\[3pt]
45\% & MV          & 8.32\% & 0.912 & $-$26.70\% & 7.61\% & 1.111 & 0.312 & 28.7\% & 30.3\% \\
45\% & MVS\_cons   & 8.55\% & 0.938 & $-$27.16\% & 7.56\% & 1.145 & 0.315 & 27.3\% & 28.8\% \\
45\% & MVS\,$\star$& 8.66\% & 0.952 & $-$27.16\% & 7.52\% & 1.165 & 0.319 & 27.1\% & 28.4\% \\
45\% & MVK         & 8.44\% & 0.928 & $-$27.64\% & 7.55\% & 1.134 & 0.305 & 28.8\% & 25.4\% \\[3pt]
50\% & MV          & 8.56\% & 0.919 & $-$27.86\% & 7.75\% & 1.121 & 0.307 & 28.7\% & 23.1\% \\
50\% & MVS\_cons   & 8.67\% & 0.933 & $-$28.15\% & 7.79\% & 1.129 & 0.308 & 29.7\% & 19.7\% \\
50\% & MVS\,$\star$& 8.69\% & 0.936 & $-$28.34\% & 7.75\% & 1.137 & 0.307 & 29.6\% & 19.3\% \\
50\% & MVK         & 8.74\% & 0.934 & $-$28.36\% & 7.82\% & 1.133 & 0.308 & 29.6\% & 17.8\% \\
\end{longtable}
\begin{minipage}{\linewidth}
\vspace{4pt}\footnotesize
